...
def create_album_with_photos(db, user_id, album_title, album_image, photo_image_list):
    ...
    for photo_image in list(set(photo_image_list)):
        ...
        photo = Photo(
            userId=user_id, title=f"{album_title} {photo_num}", imageUrl=photo_image)
